...
module BlackhawkApi
  ...
  class ProductLineRepository < Client
    ...
    def find(productline_id)
      get ProductLine.new.find productline_id
    end
    ...
    def find_summaries_by_brand(request)
      get ProductLine.new.find_summaries_by_brand request.brand_id
    end
    ...
    def find_summaries_by_ids(request)
      get ProductLine.new.find_summaries_by_ids request.productline_ids
    end
  end
end
