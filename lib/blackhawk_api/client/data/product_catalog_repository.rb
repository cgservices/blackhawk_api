...
module BlackhawkApi
  ...
  class ProductCatalogRepository < Client
    ...
    def all(request)
      get ProductCatalog.new.all request
    end
    ...
    def find(catalog_id)
      get ProductCatalog.new.find catalog_id
    end
    ...
    def find_by_name(request)
      get ProductCatalog.new.find_by_name(request.name)
    end
    ...
    def find_by_ids(request)
      get ProductCatalog.new.find_by_ids(request.catalog_ids)
    end
    ...
    def find_product_catalogs_for_product(request)
      get ProductCatalog.new.find_product_catalogs_for_product(request.product_id)
    end
    ...
    def get_version(catalog_id)
      get ProductCatalog.new.get_version catalog_id
    end
  end
end
