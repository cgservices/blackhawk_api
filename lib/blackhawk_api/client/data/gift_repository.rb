...
module BlackhawkApi
  ...
  class GiftRepository < Client
    ...
    def find(gift_id)
      get EGiftManagement.new.find gift_id
    end
    ...
    def find_by_account_id(account_id)
      get EGiftManagement.new.find_by_account_id account_id
    end
    ...
    def find_by_gift_ids(egift_ids)
      get EGiftManagement.new.find_by_egift_ids egift_ids
    end
    ...
    def generate(request, request_id)
      post EGiftProcessing.new.generate request.to_json, request_id
    end
    ...
    def reverse(request, request_id)
      post EGiftProcessing.new.reverse request.to_json, request_id
    end
    ...
    def void(request, request_id)
      post EGiftProcessing.new.void request.to_json, request_id
    end
  end
end
