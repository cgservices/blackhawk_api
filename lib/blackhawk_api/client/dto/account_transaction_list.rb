module BlackhawkApi
  # Data class for account transaction lists
  class AccountTransactionList
    attr_reader :entity_id, :creator_id, :updater_id, :created_timestamp,
                ...
                :transaction_response, :transaction_timestamp, :description, :is_void

    # Initializes a new instance for account transaction lists
    ...
    def initialize(transaction_data)
      ...
      @updated_timestamp = transaction_data.updatedTimestamp
